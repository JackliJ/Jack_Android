...
public class ChatEmotionKeyboard {
    ...
    private static final String SHARE_PREFERENCE_NAME = "ChatEmotionKeyboard";
...
//                ChatEmotiomComplateFragment.isvoide = false;
    ...
    public boolean interceptBackPress() {
        Log.d("ChatEmotionKeyboard", "mEmotionLayout.isShown():" + mEmotionLayout.isShown());
        if (mEmotionLayout.isShown()) {
...
//        EmotionMainFragment.isvoide = false;
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight < 0) {
            Log.d("ChatEmotionKeyboard", "ChatEmotionKeyboard--Warning: value of softInputHeight is below zero!");
        }
        //存一份到本地
        if (softInputHeight > 0) {
