...
import com.project.jack.utils.ScreenUtils;
 ...
 */
public class ChatHorizontalRecyclerviewAdapter extends RecyclerView.Adapter<ChatHorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public ChatHorizontalRecyclerviewAdapter(Context context, List<ImageModel> datas){
        this.datas=datas;
